...
public class SnowbirdLiftApp {
    ...
    private void runLift() {
        ...
        Gad2Chair access = gad2Lift.access(1);
        System.out.println("2nd chair has: " + access.listChairRiders());
    ...
    private void unloadLift() {
        ...
        chair = gad2Lift.deQueue();
        if (chair != null) {
            throw new IllegalStateException("Check your queue implementation! : " + chair.listChairRiders());
        } else {
